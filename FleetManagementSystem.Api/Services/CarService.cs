...
public class CarService : ICarService
{
    ...
    public List<object[]> GetCarsByHubAddress(string hubAddress)
    {
    ...
    public List<CarMaster> GetAvailableCars(int hubId, DateTime startDate, DateTime endDate, long? carTypeId)
    {
